...
│ purpose      │  discover/ │ config (JSON)            │  源特有配置
│              │  collect   │ entry_url                │  产品入口URL (2026-05-15)
│ collect_mode │ standard/  │ strategy                 │  standard/recursive (2026-05-15)
│              │  vm        │ is_active                │
│ last_valid   │            │ created_by (FK→user)     │
│ expires_at   │            │ last_collected_at        │
...
│    urgency: []       │      │                      │
│  }                   │      ▼                      ▼
│ delay_hours          │  rule_channels          delivery_log
│ delay_hours          │  ┌──────────────┐      ┌──────────────────────┐
