...
| # | 模块 | 文件 | 说明 |
|---|------|------|------|
| 01 | 仪表盘 | [01-dashboard.md](./01-dashboard.md) | 系统运行状态总览 |
| 02 | Session | [02-session.md](./02-session.md) | 绿盟登录凭证（PHPSESSID）管理 |
| 03 | 通知渠道 | [03-channels.md](./03-channels.md) | 推送通道配置（企业微信/钉钉/飞书/邮件） |
| 04 | 订阅规则 | [04-subscriptions.md](./04-subscriptions.md) | 升级通知推送规则定义 |
| 05 | 客户管理 | [05-customers.md](./05-customers.md) | 客户信息管理 |
| 06 | 采集数据 | [06-data.md](./06-data.md) | 升级包快照存储与展示 |
| 07 | 推送历史 | [07-history.md](./07-history.md) | 推送记录查询/重发/清空 |
| 08 | 系统配置 | [08-settings.md](./08-settings.md) | 调度器参数/事件通知配置 |
| 09 | 产品管理 | [09-products.md](./09-products.md) | 产品启用/禁用（默认启用5个） |
| 10 | 系统日志 | [10-system-logs.md](./10-system-logs.md) | app.log 实时查看与审计日志 |
